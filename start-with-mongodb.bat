@echo off
echo Starting Hydrogen Credit System with MongoDB Connection String...
echo.
...
echo Starting Backend Server with MongoDB Connection String...
start cmd /k "cd backend && set MONGODB_URI=mongodb://localhost:27017/hydrogen-credits && set JWT_SECRET=your-super-secret-jwt-key-here-change-this-in-production && set BLOCKCHAIN_RPC_URL=http://localhost:8545 && set CONTRACT_ADDRESS=0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9 && npm start"
...
echo.
echo All services are starting with MongoDB Connection String...
echo.
